...
\begin{figure}
\centering
\includegraphics[scale=1.0]{corrbc.jpg}
...
\begin{itemize}
\item Correct critical exponent from Widom law. %Sì ma lo devi confrontare con gli errori
...
\vspace{20pt}
The SW is \textbf{ergodic}. It can be prooved it satisfy the \textbf{detailed balance}.
